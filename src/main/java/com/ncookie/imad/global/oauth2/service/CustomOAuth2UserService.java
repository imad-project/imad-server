...
import com.ncookie.imad.global.oauth2.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        UserAccount createdUser = getUser(extractAttributes, authProvider); // getUser() 메소드로 User 객체 생성 후 반환
     ...
     */
    private UserAccount getUser(OAuthAttributes attributes, AuthProvider socialType) {
     ...
     */
    private UserAccount saveUser(OAuthAttributes attributes, AuthProvider authProvider) {
        UserAccount createdUser = attributes.toEntity(authProvider, attributes.getOauth2UserInfo());
